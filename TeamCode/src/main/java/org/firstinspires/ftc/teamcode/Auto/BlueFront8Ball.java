...
@Autonomous
public class BlueFront8Ball extends LinearOpMode {
        ...
        if (AprilTagDetected == 1){
            Actions.runBlocking(
                    drive.actionBuilder(new Pose2d(25,25,Math.toRadians(-15)))
                            ...
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,0,.35))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 1))
                            .waitSeconds(.5)
                            .stopAndAdd(new TopLeftIntake(LeftTopServo,3))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,.3,.95))
                            .waitSeconds(.15)
                            ...
                            .stopAndAdd(new StartBelt(LeftBeltServo,.125))
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .stopAndAdd(new StartBelt(RightBeltServo,-.35))
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,.775,.78,0,voltMult))
                            .strafeToLinearHeading(new Vector2d(33,22), Math.toRadians(54))
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .waitSeconds(.3)
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,.65,.6))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,0,.25))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 1))
                            .strafeToLinearHeading(new Vector2d(12,15), Math.toRadians(0))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .stopAndAdd(new LeftIntakeStart(LeftIntakeLeftServo,LeftIntakeRightServo,LeftBeltServo,-1))
                            .stopAndAdd(new StartBelt(LeftBeltServo,.35))
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,0.765,0,0,voltMult))
                            .strafeToLinearHeading(new Vector2d(43,15), Math.toRadians(56))
                            .stopAndAdd(new StartBelt(LeftBeltServo,1))
                            .waitSeconds(3.5)
                            .build()
            );
            ...
            Actions.runBlocking(
                    drive.actionBuilder(new Pose2d(25,25,Math.toRadians(-15)))
                            ...
                            .waitSeconds(.55)
                            .stopAndAdd(new StartBelt(RightBeltServo,-1))
                            .stopAndAdd(new StartBelt(LeftBeltServo,.5))
                            ...
                            //line up for ball 1
                            .strafeToLinearHeading(new Vector2d(15,30), Math.toRadians(0))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,.3,.6))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,0,.25))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 1))
                            .waitSeconds(.75)
                            .stopAndAdd(new TopLeftIntake(LeftTopServo,3))
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,.76,.775,0,voltMult))
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .stopAndAdd(new LeftIntakeStart(LeftIntakeLeftServo,LeftIntakeRightServo,LeftBeltServo,-1))
                            .stopAndAdd(new StartBelt(LeftBeltServo,.05))
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,0.75,0,0,voltMult))
            ...
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .stopAndAdd(new TopRightIntake(RightTopServo,2))
                            .stopAndAdd(new StartBelt(LeftBeltServo,-.25))
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,.775,.79,0,voltMult))
                            ...
                            .stopAndAdd(new LeftIntakeStart(LeftIntakeLeftServo,LeftIntakeRightServo,LeftBeltServo,-1))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .strafeToLinearHeading(new Vector2d(-7.5,30),Math.toRadians(0))
                            .build()
            );
            drive.updatePoseEstimate();
            Actions.runBlocking(
                    drive.actionBuilder(drive.localizer.getPose())
                            ...
                            .waitSeconds(.3)
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,.75,.75))
                            .stopAndAdd(new StrafeLeftSlow(frontLeft,frontRight,backLeft,backRight,0,.25))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 1))
                            .strafeToLinearHeading(new Vector2d(12,18), Math.toRadians(0))
                            .stopAndAdd(new TopLeftIntake(RightTopServo, 3))
                            .stopAndAdd(new LeftIntakeStart(LeftIntakeLeftServo,LeftIntakeRightServo,LeftBeltServo,-1))
                            .stopAndAdd(new StartBelt(LeftBeltServo,-.15))
                            .stopAndAdd(new PrimeLaunch(LeftLauncher,RightLauncher,0.775,0,0,voltMult))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 1))
                            .strafeToLinearHeading(new Vector2d(45,10), Math.toRadians(54))
                            .stopAndAdd(new TopLeftIntake(LeftTopServo, 3))
                            .stopAndAdd(new StartBelt(LeftBeltServo,1))
                            .waitSeconds(3.75)
                            .build()
