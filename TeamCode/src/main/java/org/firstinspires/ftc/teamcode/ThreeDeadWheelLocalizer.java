...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -2135.9399397878415; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  1820.5890210173814; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2535.0344296527924; // x position of the perpendicular encoder (in tick units)
    }
