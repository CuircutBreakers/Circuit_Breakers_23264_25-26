...
public final class TankDrive {
    ...
    public static final class MecanumDrive {
        public static class Params {
            ...
            // drive model parameters
            public double inPerTick = 0.0019943493435266744224696692704;
            public double lateralInPerTick =  0.0011707705575232032;
            public double trackWidthTicks =  5120.566033533625;

            // feedforward parameters (in tick units)
            public double kS = 1.249980215005945;
            public double kV = 0.0004441241316004521;
