...
import org.firstinspires.ftc.teamcode.CustomPathTest;
...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = TankDrive.MecanumDrive.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(TankDrive.MecanumDrive.class)) {
            dvf = hardwareMap -> {
                TankDrive.MecanumDrive md = new TankDrive.MecanumDrive(hardwareMap, new Pose2d(0, 0, 0));
                ...
                if (md.localizer instanceof TankDrive.MecanumDrive.DriveLocalizer) {
                    TankDrive.MecanumDrive.DriveLocalizer dl = (TankDrive.MecanumDrive.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        TankDrive.MecanumDrive.PARAMS.inPerTick,
                        TankDrive.MecanumDrive.PARAMS.maxWheelVel,
                        TankDrive.MecanumDrive.PARAMS.minProfileAccel,
                        TankDrive.MecanumDrive.PARAMS.maxProfileAccel,
                        encoderGroups,
                        Arrays.asList(
                                md.leftFront,
                                md.leftBack
                        ...
                        lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(TankDrive.MecanumDrive.PARAMS.kS,
                                TankDrive.MecanumDrive.PARAMS.kV / TankDrive.MecanumDrive.PARAMS.inPerTick,
                                TankDrive.MecanumDrive.PARAMS.kA / TankDrive.MecanumDrive.PARAMS.inPerTick),
                        0
                );
            };
        ...
        manager.register(metaForClass(CustomPathTest.class), CustomPathTest.class);
